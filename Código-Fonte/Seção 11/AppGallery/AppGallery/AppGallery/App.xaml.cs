    ...
    public partial class App : Application
    {
        ...
        public static List<PaginaColecao> MenuItensColecao { 
            get {
                ...
                {
                    new Pagina() { Nome = "Pincéis (Brushes)", Descricao = "Uma nova forma de preencher os controles", ArquivoPagina = typeof(XamarinForms.XF48XF50.Pinceis), TemNavegacao = true },
                    new Pagina() { Nome = "Arrastar e Soltar (DragAndDrop)", Descricao = "Um novo gesto que permite arrastar e soltar controles", ArquivoPagina = typeof(XamarinForms.XF48XF50.ArrastarSoltar), TemNavegacao = true },
                };
